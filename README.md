...
Before AI, an author with means would hand the work around the writing to other people: developmental editors, line editors, copy editors, proofreaders, beta readers, a production department for the print and ebook files. This repo is that team, packaged as an [Obsidian](https://obsidian.md) vault wired for [Claude Code](https://claude.com/claude-code). You write the fiction; the house does everything else, from the first idea note to the files you upload to Amazon KDP.
